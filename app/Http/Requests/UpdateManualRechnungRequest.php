...
class UpdateManualRechnungRequest extends FormRequest
{
    public function authorize(): bool
    {
        $rechnung = $this->route('manual_rechnung');

        return $rechnung instanceof Rechnung
            && ($this->user()?->can('update', $rechnung) ?? false);
    }
